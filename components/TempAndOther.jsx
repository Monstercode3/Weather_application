...
const TempAndOther = ({weather: {
    ...
    return (
        <div>
            ...
            <div className="flex flex-row items-center justify-center py-1 gap-x-20">
            <img src={icon}
                    alt="weather icon"
                    className="w-20"/>
                ...
                <div className="flex flex-col space-y-3 items-start" >

                    {
                        verticalDetails.map(({ id, Icon, title, value }) => (
                            <div key={id} className="flex flex-light text-sm items-center justify-center" >
